...
module.exports = function (context) {
  ...
  if (cnt.indexOf("NotificationService.m") > -1) {
    ...
    var appended = section.replace(
      matchs[1],
      matchs[1] + "\t\t\t\tFFFFFFFFFFFFFFFFFFFF0CC6 /* NotificationServiceExtension.appex */,\n"
    ); // Store new section
    ...
    var appended = section.replace(
      matchs[1],
      matchs[1] + "\t\t\t\tFFFFFFFFFFFFFFFFFFFF1F29 /* NotificationServiceExtension */,\n"
    ); // Store new section
    ...
    var appended = section.replace(
      matchs[1],
      matchs[1] + "\t\t\t\tFFFFFFFFFFFFFFFFFFFF2C80 /* Embed App Extensions */,\n"
    ); // Store new section

    appended = appended.replace(
      matchs[3],
      matchs[3] + "\t\t\t\tFFFFFFFFFFFFFFFFFFFF9CCD /* PBXTargetDependency */,\n"
    ); // Store new section
    ...
    appended = appended.replace(
      matchs[3],
      matchs[3] + "\t\t\t\tFFFFFFFFFFFFFFFFFFFF5D00 /* NotificationServiceExtension */,\n"
    ); // Store new section
  ...
  if (!fs.existsSync(onesignalDir)) {
    ...
    console.log(log + "Folder NotificationServiceExtension already exists [Skip]");
  }
